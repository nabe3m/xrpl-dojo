...
トラストライン機能によってユーザーは他のユーザーや発行体が発行した資産を自分のアカウントで保持し、取引することを許可しています。例えば、アリスがチャーリーに対してトラストラインを設定することで、、チャーリーが発行体のトークンをアリスは受け取ることが可能となります。
...
1. コマンドラインで以下のコマンドを実行して、スクリプトを実行します。
    ...
    ```bash
    {
        id: 8,
        result: {
            Account: 'rusJXJ5ba76K9MBC7RcUyTCJx8XdEBHoi', // アリスのアドレス
            Fee: '12', // 手数料
            Flags: 0,
            ...
            date: 767754233,
            hash: '3AB395F4D04A56AB59B80BD5A2856C9EF2F8F35D08B5F6AF1546F300872F2826', // ハッシュ値
            inLedger: 265626,
            ledger_index: 265626, // レジャーインデックス番号
            meta: {
                AffectedNodes: [Array],
                TransactionIndex: 0,
