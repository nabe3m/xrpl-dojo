...
2. 成功すれば、コンソールに以下が表示されます。
    ...
    ```bash
    {
        ...
        result: {
            ...
            Destination: 'rusJXJ5ba76K9MBC7RcUyTCJx8XdEBHoi',
                ...
                date: 767755690,
                hash: 'DAEED2C83399A39700377C11BABDBAA218E60A5926E012AD8114597538D355C8',
                inLedger: 266091,
                ledger_index: 266091,
                meta: {
                AffectedNodes: [Array],
    ...
    実際に私が送信したアカウントは[こちら](https://test.bithomp.com/explorer/rusJXJ5ba76K9MBC7RcUyTCJx8XdEBHoi)です。10DOJを保有している状態になっていることが確認できます。
