---
title: How to Set Up a Trust Line | XRPL Development with JavaScript Level 1
description:  Introducing the trust line functionality as part of the Level 1 curriculum for developing XRPL with JavaScript.
sidebar:
...
The trust line feature of XRPL (XRP Ledger) allows users to indicate their intention to accept specific currencies. This is used to handle assets other than XRP on XRPL. For example, if a user wants to accept a token from another issuer, they need to set a trust line for that currency.
