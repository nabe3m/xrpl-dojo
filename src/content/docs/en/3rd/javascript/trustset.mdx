---
title: Setting Trust Lines | XRPL Development in JavaScript - Part 3
...
For a basic explanation of trust lines, please refer to [this page](/beginners/javascript/trustline/).
