---
title: Creating Test Accounts |  XRPL Development in JavaScript - Part 3
...
By doing this, you can call common account information across files with a little effort.

I believe this will help you progress efficiently with your learning, and you can also apply it to your own product ideas.

<Aside title="About Accounts" type="danger">
In this guide, we create account information for learning purposes on the testnet.
For actual accounts used on the mainnet, do not save the secret key (private key) on the internet and manage it strictly.
</Aside>