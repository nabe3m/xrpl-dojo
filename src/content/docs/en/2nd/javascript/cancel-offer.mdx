...
While DEXs generally have a reputation for being very complex, XRPL makes it relatively easy to interact with them using the JavaScript library.

Having covered trust lines, token issuance and transfer, and offer creation, checking, and cancellation, the next step will be an explanation of "cross-currency payments."